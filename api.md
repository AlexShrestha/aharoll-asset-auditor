...
- `AUDIT_API_KEY`
- `AUDIT_WORKER_TOKEN`
- `AUDIT_EVENTS_WEBHOOK_URL`
- `AUDIT_EVENTS_WEBHOOK_TOKEN` (recommended)
...
## Global Event Webhook

In addition to the per-job completion callback, the queue can emit global operational events to a webhook configured by environment variables:

- `AUDIT_EVENTS_WEBHOOK_URL`
- `AUDIT_EVENTS_WEBHOOK_TOKEN`

Headers:

- `Content-Type: application/json`
- `x-webhook-token: <AUDIT_EVENTS_WEBHOOK_TOKEN>` when configured
...
```json
{
  ...
  "normalizedStoreUrl": "https://example-store.com",
  "category": "Dresses",
  "error": "Shopify returned 403: Forbidden",
  "failedAt": "2026-03-11T09:12:18.000Z"
}
```

### `error`

This event is emitted for both job-level and product-level failures.
...
```json
{
  ...
  "occurredAt": "2026-03-11T09:12:18.000Z"
}
```
...
```json
{
  ...
  "normalizedStoreUrl": "https://example-store.com",
  "productId": 42,
  "productTitle": "Booked And Busy Ruffle Hem Bodycon Mini Dress",
  "productUrl": "https://example-store.com/products/booked-and-busy",
  "sequenceNo": 42,
  "error": "Analysis failed",
  "occurredAt": "2026-03-11T09:32:44.000Z"
}
```
...
```json
{
  ...
  "normalizedStoreUrl": "https://example-store.com",
  "category": "Dresses",
  "generatedAt": "2026-03-11T11:18:12.000Z",
  "report": {
    "totalProducts": 3574,
    "processedProducts": 3558,
    "failedProducts": 16,
